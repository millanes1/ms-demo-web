  ...
  if (isProd) {
    ...
    config.plugins.push(
      ...
      new CopyWebpackPlugin([
         { from: __dirname + '/src/main/img', to: 'img' },
         { from: __dirname + '/src/main/languages', to: 'languages' }
      ])
   )
  }
